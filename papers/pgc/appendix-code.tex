...
This appendix gives a Simplicity implementation of the checks discussed in this paper and maps the native audit verifier to Section~\ref{sec:construction}.
...
Write a compressed curve point as $(\eta,x_C)$, where $\eta$ is the SEC~1 parity bit defined in Section~\ref{sec:recovery-record}.
