...
impl UserProgram {
    pub const SOURCE: &'static str = derived_user::USER_CONTRACT_SOURCE;
    #[must_use]
...
impl AsRef<Program> for UserProgram {
    fn as_ref(&self) -> &Program {
        &self.program
    }
}
impl AsMut<Program> for UserProgram {
    fn as_mut(&mut self) -> &mut Program {
        &mut self.program
    }
}
include_simf!("src/artifacts/simf/user.simf");
