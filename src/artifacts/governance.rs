...
impl GovernanceProgram {
    pub const SOURCE: &'static str = derived_governance::GOVERNANCE_CONTRACT_SOURCE;
    #[must_use]
...
impl AsRef<Program> for GovernanceProgram {
    fn as_ref(&self) -> &Program {
        &self.program
    }
}
impl AsMut<Program> for GovernanceProgram {
    fn as_mut(&mut self) -> &mut Program {
        &mut self.program
    }
}
include_simf!("src/artifacts/simf/governance.simf");
