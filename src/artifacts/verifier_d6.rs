...
pub struct VerifierD6Program {
    program: Program,
}
impl VerifierD6Program {
    pub const SOURCE: &'static str = derived_verifier_d6::VERIFIER_D6_CONTRACT_SOURCE;
    #[must_use]
...
impl AsRef<Program> for VerifierD6Program {
    fn as_ref(&self) -> &Program {
        &self.program
    }
}
impl AsMut<Program> for VerifierD6Program {
    fn as_mut(&mut self) -> &mut Program {
        &mut self.program
    }
}
include_simf!("src/artifacts/simf/verifier_d6.simf");
