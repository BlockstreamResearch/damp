...
pub struct VerifierD5Program {
    program: Program,
}
impl VerifierD5Program {
    pub const SOURCE: &'static str = derived_verifier_d5::VERIFIER_D5_CONTRACT_SOURCE;
    #[must_use]
...
impl AsRef<Program> for VerifierD5Program {
    fn as_ref(&self) -> &Program {
        &self.program
    }
}
impl AsMut<Program> for VerifierD5Program {
    fn as_mut(&mut self) -> &mut Program {
        &mut self.program
    }
}
include_simf!("src/artifacts/simf/verifier_d5.simf");
