...
impl VerifierProgram {
    pub const SOURCE: &'static str = derived_verifier::VERIFIER_CONTRACT_SOURCE;
    #[must_use]
...
impl AsRef<Program> for VerifierProgram {
    fn as_ref(&self) -> &Program {
        &self.program
    }
}
impl AsMut<Program> for VerifierProgram {
    fn as_mut(&mut self) -> &mut Program {
        &mut self.program
    }
}
include_simf!("src/artifacts/simf/verifier.simf");
